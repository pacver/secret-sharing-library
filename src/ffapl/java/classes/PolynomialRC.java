...
public class PolynomialRC extends Polynomial {
	 ...
	 */
	public PolynomialRC(BigInteger modulus, Thread thread) {
		super(thread);
	...
	public PolynomialRC(TreeMap<BigInteger, BigInteger> polynomTable, 
			BigInteger modulus, Thread thread) {
	 ...
	 * @throws FFaplAlgebraicException
	 */
	public PolynomialRC(BigInteger c, BigInteger e, BigInteger modulus, Thread thread) {
	 ...
	 * @throws FFaplAlgebraicException
	 */
	public PolynomialRC(long c, long e, long modulus, Thread thread) {
