  ...
  public void run()
  {
        try
        {
                ...
                _logger.log(ILevel.ERROR,
                                        CompilerMessage.getError(pe, _programName),
                                        pe.errorLine(),
                                        pe.errorColumn());
        }catch(TokenMgrError te){
                _logger.log(ILevel.ERROR,
                                        CompilerMessage.getError(te, _programName),
                                        te.errorLine(),
                                        te.errorColumn());
        }catch(FFaplAlgebraicException e){
                        _logger.log(ILevel.ERROR, CompilerMessage.getError(e, _programName),
                                    e.errorLine(),
                                    e.errorColumn());
                }catch(FFaplException ffe){
                _logger.log(ILevel.ERROR, CompilerMessage.getError(ffe, _programName),
                            ffe.errorLine(),
                            ffe.errorColumn());
...
/* Operations */
  final public ASTRelOp RelOp() throws ParseException {
  Token t1;
  FFaplNodeToken t2;
  FFaplNodeChoice t3;
  int pos = 0;
  ...
  final public ASTEqualOp EqualOp() throws ParseException {
  Token t1;
  FFaplNodeToken t2;
  FFaplNodeChoice t3;
  int pos = 0;
  ...
  final public ASTAddOp AddOp() throws ParseException {
  Token t1;
  FFaplNodeToken t2;
  FFaplNodeChoice t3;
  int pos = 0;
  ...
  final public ASTMulOp MulOp() throws ParseException {
  Token t1;
  FFaplNodeToken t2;
  FFaplNodeChoice t3;
  int pos = 0;
 ...
 FFaplNodeSequence t7;
  ...
  final public ASTECAssignment ECAssignment() throws ParseException {
  Token t1;
  ...
  final public ASTBreak Break() throws ParseException {
  Token t1;
  FFaplNodeToken t2;
  ...
  final public ASTAlgebraicType AlgebraicType() throws ParseException {
  FFaplNodeChoice t1;
  Token t2;
  //ASTExpr t7;
  FFaplNodeType t8;
  ...
  final public ASTECBaseField ECBaseField() throws ParseException {
        Token t1;
        FFaplNodeToken t2;
        FFaplNodeToken t3;
        FFaplNodeChoice t4;
  ...
  final public ASTSameAs SameAs() throws ParseException {
        Token t1;
        FFaplNodeToken t2;
  ...
  final public ASTComplexAlgebraicType ComplexAlgebraicType() throws ParseException {
  FFaplNodeChoice t1;
  ASTRecord t3;
  Token t5;
  ...
  final public ASTRandomGeneratorType RandomGeneratorType() throws ParseException {
  FFaplNodeChoice t1;
  ASTRecord t3;
  Token t5;
  FFaplNodeSequence t6, t7;
  ...
  final public ASTECPAI ECPAI() throws ParseException {
  Token t1;
  FFaplNodeToken t2, t3;
    t1 = jj_consume_token(ECLEFT);
  ...
  final public ASTECRandom ECRandom() throws ParseException {
  Token t1;
  FFaplNodeToken t2;
  FFaplNodeChoice t3;
  int amount = 2;
  ...
  private boolean jj_3R_58() {
      return jj_scan_token(CURLY_BRACE_LEFT);
  }
  ...
  private boolean jj_3R_72() {
      return jj_scan_token(SQUARED_BRACE_LEFT);
  }
  ...
  private boolean jj_3R_30() {
    if (jj_scan_token(IDENT)) return true;
      return jj_scan_token(BRACE_LEFT);
  }
  ...
  private boolean jj_3R_67() {
      return jj_scan_token(HEXNUMBER);
  }
  ...
  private boolean jj_3R_38() {
      return jj_scan_token(ECRANDOMSUB);
  }
